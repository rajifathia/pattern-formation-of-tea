...
# ╔═╡ 74fbe358-8250-4f13-a26c-b3a9a68863ab
using Pkg

# ╔═╡ 2b58e6cd-878f-438c-943e-3e53a38abd9d
begin
	using WGLMakie
	WGLMakie.activate!()
end

# ╔═╡ d8593060-0551-432e-966e-85326e425705
begin
...
# ╔═╡ ba7ce5cb-c5bc-451b-a867-348694dc8b3a
begin
    r = data[:, 1]
    θ = data[:, 2]
    z = data[:, 3]
...
# ╔═╡ 923b63a7-40a6-4924-8255-284afaca2af9
begin
    # Geometry conversion for DISPLAY ONLY.
    # The CFD variables remain r, θ, z.
    radial_position = r .* cos.(θ)
    circumferential_position = r .* sin.(θ)

    fig = Figure(size = (1000, 800))

    ax = Axis3(
        fig[1, 1],
        xlabel = "cylinder radial direction",
        ylabel = "cylinder circumferential direction",
        zlabel = "z",
...
manifest_format = "2.0"
project_hash = "b27051829ede95e7e5f7733c6de3b872e8052401"
